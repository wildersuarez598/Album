  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-md items-center px-4 py-10">
      <section className="w-full space-y-6 rounded-3xl border border-slate-800 bg-slate-950/90 p-8 shadow-soft">
        <div>
          <p className="text-sm uppercase tracking-[0.35em] text-slate-500">Crear cuenta</p>
          <h1 className="mt-3 text-3xl font-semibold text-slate-100">Regístrate</h1>
        </div>
        ...
        <p className="text-center text-sm text-slate-400">
          ¿Ya tienes cuenta?{' '}
          <Link className="text-panini-300 hover:text-panini-200" to="/auth/login">
            Inicia sesión
          </Link>
        </p>
      </section>
